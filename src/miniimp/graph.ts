...
export type ExitNode = { next?: undefined } & SimpleNode;
...
export function exportGraph(graph: Graph, showSkip: boolean = true): string {
    return graphToDOT({
        entry: graph.entry,
        labelShape: node => {
...
export function exportBlockGraph(graph: BlockGraph,
