...
//export function analyzeDefinedVars(graph: Graph): Map<Node, DefinedVars> {
//    /* this DFS will recursively give us the defined vars for this node */
//    function traverse(node: Node): DefinedVars {
//    }
//}
